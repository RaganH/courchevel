    ...
    static int Main(string[] args)
    {
      try
      {
        ...
        try
        {
          ...
          eventLoop.Register<House, HouseBehaviour>((deps, data, id) => new HouseBehaviour(deps, data, id));
          eventLoop.RegisterCommandHandler<House.Commands.Deposit, HouseBehaviour>();
        }
        catch (Exception e)
        {
